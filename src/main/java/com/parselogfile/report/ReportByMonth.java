...
import com.parselogfile.count.CountByMonth;
...
public class ReportByMonth extends Report {
    ...
    public ReportByMonth(Map<String, List<List<String>>> data) {

        count = new CountByMonth();
